...
cp $LOCAL_BUILD_DIR/docs/public/examples/basic.html $LOCAL_STAGING_DIR_STD/$CUI_PREFIX
cp $LOCAL_BUILD_DIR/docs/public/examples/standard.html $LOCAL_STAGING_DIR_STD/$CUI_PREFIX
cp $LOCAL_BUILD_DIR/docs/public/examples/wide.html $LOCAL_STAGING_DIR_STD/$CUI_PREFIX
...
cp $LOCAL_BUILD_DIR/docs/public/examples/basic.html $LOCAL_STAGING_DIR_SRC/$CUI_PREFIX
cp $LOCAL_BUILD_DIR/docs/public/examples/standard.html $LOCAL_STAGING_DIR_SRC/$CUI_PREFIX
cp $LOCAL_BUILD_DIR/docs/public/examples/wide.html $LOCAL_STAGING_DIR_SRC/$CUI_PREFIX
